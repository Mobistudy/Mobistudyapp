<template>
  <p>
    ...
    Personnel from the University of Oxford may access your data for technical maintenance.
    <br />
    ...
    <br />
    You can remove your profile from Mobistudy whenever you want. This
