<template>
  <div>
    ...
    <div
      class="mobitxt1"
      v-html="studyDescription.generalities.longDescription[$i18n.locale]"
    >
    </div>
    <q-separator class="q-my-md" />
    ...
    <q-list
      v-for="(institution, index) in studyDescription.generalities.institutions"
      :key="index + 'in'"
    >
      <q-item>
        <q-item-section>
      ...
      <q-separator
        class="q-my-md"
        inset
        v-if="index != studyDescription.generalities.institutions.length-1"
      />
