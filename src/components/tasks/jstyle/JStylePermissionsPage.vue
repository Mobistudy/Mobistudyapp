<template>
  <q-page padding>
    ...
    <div class="mobitxt1 q-pa-md">{{ $q.platform.is.ios ? $t('tasks.jstyle.OSpermissioniOS') :
      $t('tasks.jstyle.OSpermissionAndroid') }}</div>
...
export default {
  name: 'JStylePermissionsPage',
  props: ['studyKey', 'taskId'],
  i18n: {
    messages: mergeDeep(i18nCommon, i18nStudies, i18nJStyle)
  },
  data () {
    return {
