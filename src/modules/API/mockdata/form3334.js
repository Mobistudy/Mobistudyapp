export default {
  ...
  description: {
    en: `Weekly Questionnaire about your asthma condition
    `
  },
  questions: [{
    id: 'Q1',
  ...
  },
  {
    ...
    type: 'singleChoice',
    text: {
      en: `1. Which of the following statement best describes how your sleep was affected in the last one week`
    },
    helper: {
      en: ''
    },
    ...
    answerChoices: [{
      id: 'Q2A1',
      text: {
        en: 'I have not woken up at all due to my asthma symptoms '
      }
    },
    {
      id: 'Q2A2',
      text: {
        en: 'I have woken up a little due to my asthma symptoms'
      }
    },
    {
      id: 'Q2A3',
      text: {
        en: 'I have woken up somewhat due to my asthma symptoms'
      }
    },
    {
      id: 'Q2A4',
      text: {
        en: 'I have woken up several times due to my asthma symptoms'
      }
    },
    {
      id: 'Q2A5',
      text: {
        en: 'I have not been able to sleep due to my asthma'
      }
    }]
  },
  {
