<template>
  <q-page padding>
    <q-tabs underline-color="secondary" align="center" class="" swipeable="true">
      <q-tab name="heart_rate" @click="changeTab('heart_rate')" default icon="favorite_border" label="Heart Rate"/>
      <q-tab name="steps" @click="changeTab('steps')" icon="directions_walk" label="Steps" />
      <q-tab name="calories" @click="changeTab('calories')" icon="whatshot" label="Calories" />
    </q-tabs>
