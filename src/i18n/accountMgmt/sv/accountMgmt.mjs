...
export default {
  ...
  profile: {
    ...
    conditions: 'CARL: Långsiktiga förhållanden',
    conditionsSearch: 'CARL: Type a word to search for a condition',
    conditionSearchError: 'CARL: Cannot find disease',
    noResults: 'CARL: No results',
