export default `
  ...
  <p>
     ...
     Para utilizar la app deberás crear una cuenta de la app que se compartirá con Mobistudy en un servidor.
     Este perfil es necesario independientemente de si se une o no a un estudio de investigación. El perfil requiere la siguiente
     información:
  </p>

  <ul>
    <li>
      Cuenta de e-mail. Es necesario para identificarse, te permite iniciar sesión y recuperar tu contraseña
    </li>
    <li>
      Nombre y apellido. Son necesarios para personalizar los mensajes que se te enviarán o para identificar a los participantes en los estudios que sean necesario
    </li>
    <li>
      Fecha de nacimiento. Es necesatio para el emparejamiento de tu perfil con los criterios de inclusión de los estudios disponibles
    </li>
    <li>
      Género. Es necesario para el emparejamiento de tu perfil con los criterios de inclusión de los estudios disponibles
    </li>
    <li>
      Condiciones crónicas, como el asma o la diabetes. Es necesario para el emparejamiento de tu perfil con los criterios de inclusión de los estudios disponibles
    </li>
    <li>
      Medicación que tomas regularmente, por ejemplo la insulina. Es necesario para el emparejamiento de tu perfil con los criterios de inclusión de los estudios disponibles
    </li>
    <li>
      Peso y altura. Son necesarios para el emparejamiento de tu perfil con los criterios de inclusión
      de los estudios disponibles y configurar las actividades que puede utilizar utilizando la app
    </li>
  </ul>

  <p>
    Además de los datos contenidos en este perfil, la app recopilará y compartirá información sobre tu
    participación en estudios de investigación con el servidor de Mobistudy, como la fecha y hora en que te uniste o te retiraste de un
    estudio, o la fecha y hora de las actividades que realizaste dentro de un estudio. Estos datos son necesarios para realizar un seguimiento de tu
    participación en estudios existentes y evitar invitarte a estudios en los que ya estés participando, o estudios que
    no son adecuados para formar parte de ellos simultáneamente
  </p>

  <p>
    Si decides participar en un estudio de investigación, es posible que debas compartir tus datos con las instituciones involucradas en el
    estudio, que incluyen:
  </p>
  <ul>
    <li>
      Respuestas dadas en los cuestionarios y solicitudes
    </li>
    <li>
      Datos recogidos desde Google Fit (Android phones), or HealthKit (iPhones). Solamente si los datos son relevantes para el estudio
    ...
    <li>
      Flujo espiratorio máximo medido por el medidor de flujo máximo inteligente.
    </li>
    <li>
      Posición geográfica recogida para la tarea de posicionamiento.
    </li>
    <li>
  ...
  <p>
    Todos los datos recopilados se transfieren y almacenan de forma segura en un servidor alojado y administrado por la Universidad de
