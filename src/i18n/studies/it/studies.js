const studies = {
  studies: {
    ...
    studyCompletedText: 'Hai completato tutte le attività per lo studio {studyname}.<br><br>Grazie mille per il tuo contributo!<br><br>Ricorda che alcuni studi potrebbero richiedere ulteriori azioni, controlla la descrizione dello studio nel menu "Gestisci studi".',
    ...
    consent: {
      ...
      remindersConsent: 'Voglio ricevere promemoria riguardo alle attività di questo studio',
