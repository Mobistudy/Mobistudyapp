export default {
  ...
  description: {
    it: 'Con questo questionario vorremmo sapere alcune cose su di Lei e sulla Sua salute. La preghiamo di rispondere a tutte le domande selezionando l\'opzione che meglio corrisponde alla Sua risposta. Non esiste una risposta “giusta” o “sbagliata”. Le Sue informazioni verranno tenute strettamente riservate.',
    en: 'We are interested in some things about you and your health. Please answer all of the questions yourself by selecting the option that best applies to you.There are no "right" or "wrong" answers. The information that you provide will remain strictly confidential.'
  },
